  ...
  return (
    <>
      ...
      <CRow lg="12" style={{ margin: "0px 0px 30px 20px" }}>
        <CCol lg="3"></CCol>
        <CCol lg="2">
          <CButton className="add-btn" onClick={props.saveFunction}>
            Save
          </CButton>
        </CCol>
      </CRow>
      ...
      <CRow lg="12" style={{ margin: "0px 0px 30px 20px" }}>
        <CCol lg="3">
          <CLabel>Student Gender is:</CLabel>
        </CCol>
        <CCol>
      ...
      <CRow lg="12" style={{ margin: "0px 0px 30px 20px" }}>
        <CCol lg="3">
          <CLabel>Student Skill are:</CLabel>
        </CCol>
        <CCol>
